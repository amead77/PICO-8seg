# source for ubuntu 25.04 to read cpu usage from the local pc and send it via serial to a raspberry pi pico.
# the raspberry pi pico will then display the cpu usage on a waveshare 8-segment display.
# the pico is connected by usb to the pc.
#
#
#
#!/usr/bin/env python3
